...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1gn8XeNE2J?p=97)
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|20|news\_name|String|公告信息名称|是|
|21|news\_types|Integer|公告信息类型|是|
|22|news\_photo|String|公告信息图片|是|
|23|insert\_time|Date|公告信息时间|是|
|24|news\_content|String|公告信息详情|是|
...
|34|tushu\_types|Integer|图书类型|是|
